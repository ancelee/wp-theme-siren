...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		<div id="pagination" <?php if(akina_option('image_category') && is_category(explode(',',akina_option('image_category')))) echo 'class="pagination-archive"'; ?>><?php next_posts_link(__('加载更多')); ?></div>
		<?php }else{ ?>
		<nav class="navigator">
