...
.feature i , .feature-title span , .download , .navigator i:hover , .links ul li:before , .ar-time i , span.ar-circle , .object , .comment .comment-reply-link , .siren-checkbox-radio:checked + .siren-checkbox-radioInput:after , .post-con:hover .vertical-line{ background: <?php echo akina_option('theme_skin'); ?> }
...
.feature img{ border-radius: 30%; !important; }
<?php } // liststyle ?>
<?php // comments
